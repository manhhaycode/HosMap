const headerSearch = document.querySelector(
  ".container-tab-funtion-map--header_search"
);
const headerNavigate = document.querySelector(
  ".container-tab-funtion-map--header_navigate"
);
const mapControlContainer = document.querySelector(
  ".container-tab-function-map"
);
const mapControlSearch = document.querySelector(".tab-funtion-map--controls");
const mapControlNavigate = document.querySelector(
  ".tab-funtion-map--controls__navigate"
);
const directSearch = document.querySelector(".direct-search");
const mapContainer = document.querySelector(".map-container");
const mapSearchLocationContainer = document.querySelector(
  ".map-search-location--icon-container"
);
...
document
  .querySelector(".load-page")
  .insertBefore(imgLoadPage, document.querySelector(".load-page").firstChild);
