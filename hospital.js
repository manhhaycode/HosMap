...
function distance(coordinates1, coordinates2) {
    var lat1 = coordinatesToLatLon(coordinates1)[0];
    var lon1 = coordinatesToLatLon(coordinates1)[1];
    var lat2 = coordinatesToLatLon(coordinates2)[0];
    var lon2 = coordinatesToLatLon(coordinates2)[1];
